...
export const COTAS_TITLE = "Acotaciones";
export const ACCESIBILIDAD = "Accesibilidad";
export const ACCESIBILIDAD_COTAS = "Da clic en el ícono de accesibilidad para visualizar las acotaciones correspondientes a la tabla.";
